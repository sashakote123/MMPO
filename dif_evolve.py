...
def differential_evolution(f, bounds, pop_size, mut, crossp, maxiter):
...
def differential_evolution2(f, bounds, pop_size, mut, crossp, maxiter, w0_list):
...
bounds = [(0, 1)] * N
result, score, cost, itr = differential_evolution(Fitness2, bounds, N, 0.7, 0.3, 50)
